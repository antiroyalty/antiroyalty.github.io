...
For smaller pieces, scoring the glass and then separating it with pliers (holding the glass on both ends) is a good approach -- the glass pieces may be too small to hold one side with pliers and the other with your hands.

Then comes the sanding stage. We used a diamond cutter sander. You want to sand each edge at least a bit, so that the sharp imperfections of cutting the glass are smoothed over. This is also your chance to correct any inner curves that might have been too "shallow", ie you didn't score it to the full edge of your design since the angle of your design was too steep. Note that the grinder can allow you to do many things, but it's a tradeoff of time. You really do want to get the glass "cut" as much as possible, because sanding it down in the grinder can take ages. Not to mention little glass dust particles that you're breathing for a long long time. Make sure you wear eye protection for this part. And a mask, or commit to breathing through your nose.
