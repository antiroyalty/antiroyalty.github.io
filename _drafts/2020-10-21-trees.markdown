...
def sorted_array_to_bst_helper(array)
    ...
    puts "array: #{array}; length #{array.length}"
...
def merge(nums1, m, nums2, n)
    ...
    (0).upto(m+n) do |k|
        ...
        puts "num1_val #{num1_val}; num2_val #{num2_val}; k #{k}; i #{i}; j #{j}"
...
def is_valid_bst(root)
    # DLR = preorder
    # LDR = inorder
    # Need to know the node's key at lower levels to check validity, so use preorder
